...
/* bu uygulamanin bir benzerini daha once yapmistik. bu uygulamada ise cift elemanli dizinin orta degeri, ortalamayi ve modu bulacagiz.
...
void median(unsigned int answer[])
{
	...
	/* eleman sayisi cift olan dizilerde iki medyan vardir. Bu nedenle iki formul kullanilir
	 * 1. medyan sirasi = eleman sayisi / 2
	 * 2. medyan sirasi = eleman sayisi / 2 + 1
	*/
	printf("\n\nCift elemanli dizilerde iki adet medyan bulunur.\n"
		   "************************************************\n"
		   "1. medyan sirasi = %d\n2. medyan sirasi = %d\n\n"
		   "1. medyan degeri = %d\n2. medyan degeri = %d\n",
			SIZE / 2, (SIZE / 2) + 1, answer[SIZE / 2], answer[(SIZE / 2) + 1]);
}
...
/* dizinin dogru orta elemanini bulmak icin dizi elemanlarini siralamaliyiz */
void bubbleSort(unsigned int arr[])
{
